...
export const PAGES: PageEntry[] = [
  ...
  { label: "SAT Prep", href: "/sat", group: "SAT Prep", keywords: ["sat", "psat", "nmsqt", "test prep", "college board", "scoreclimb", "countdown", "question of the day"] },
  { label: "SAT practice", href: "/sat/practice", group: "SAT Prep", keywords: ["sat questions", "practice set", "daily mix", "reading and writing", "math questions", "domains", "skills"] },
  { label: "SAT practice exams", href: "/sat/exams", group: "SAT Prep", keywords: ["mock exam", "full length", "adaptive", "timed test", "bluebook", "psat exam", "exam library"] },
  { label: "SAT review mistakes", href: "/sat/review", group: "SAT Prep", keywords: ["missed questions", "wrong answers", "retry", "errors"] },
  { label: "SAT question bank", href: "/sat/bank", group: "SAT Prep", keywords: ["question id", "college board bank", "browse questions", "teacher assigned"] },
  { label: "SAT flashcards", href: "/sat/flashcards", group: "SAT Prep", keywords: ["vocab", "vocabulary", "flashcards", "latin", "greek", "roots", "words"] },
  { label: "SAT study guides", href: "/sat/guides", group: "SAT Prep", keywords: ["formulas", "grammar rules", "math guide", "english guide", "cheat sheet"] },
  { label: "SAT progress", href: "/sat/progress", group: "SAT Prep", keywords: ["predicted score", "score estimate", "strengths", "weaknesses", "sat stats", "outside exams"] },
  { label: "SAT settings", href: "/sat/settings", group: "SAT Prep", keywords: ["test date", "target score", "daily goal", "ap scores", "backup", "restore", "sat reset"] },
